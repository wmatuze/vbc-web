...
const seedFoundationClassSessions = async () => {
  try {
    ...
    if (existingCount > 0) {
      console.log(`Found ${existingCount} existing foundation class sessions, skipping seeding.`);
      return;
    }
    ...
    console.log(`Successfully seeded ${result.length} foundation class sessions.`);
