...
const FoundationClasses = () => {
  ...
  const classSessions = [
    {
      ...
      description: "Explore the fundamentals of salvation, the significance of being born again, and the purpose of the local church in a believer's life.",
      topics: ["The plan of salvation", "What it means to be born again", "The purpose of the local church", "Introduction to our church's history"],
      icon: <FaPray className="text-blue-500" />,
    },
    {
      week: 2,
      title: "Bible Study Methods and Prayer Life",
      description: "Learn practical methods for effective Bible study and develop a consistent prayer life that deepens your relationship with God.",
      topics: ["How to study the Bible effectively", "Understanding different Bible translations", "Developing a consistent prayer life", "Types of prayer"],
      icon: <FaBible className="text-blue-500" />,
    },
    {
      week: 3,
      title: "Spiritual Gifts and Service",
      description: "Discover your unique spiritual gifts and learn how to use them effectively in serving within the church community.",
      topics: ["Understanding spiritual gifts", "Identifying your spiritual gifts", "Areas of service in the church", "The importance of volunteering"],
      icon: <FaHandHoldingHeart className="text-blue-500" />,
    },
    {
      week: 4,
      title: "Church Mission and Membership Responsibilities",
      description: "Understand our church's mission and vision, and learn about the expectations and benefits of becoming an active member.",
      topics: ["Church mission and vision", "Membership responsibilities", "Financial stewardship", "Next steps after membership"],
  ...
  const faqItems = [
    {
      ...
      answer: "Yes, attendance at all four classes is required to complete the Foundation Classes series. Each class builds on the previous one to provide a comprehensive foundation for your faith and church membership."
    },
    {
      question: "What if I miss a class?",
      answer: "If you miss a class, you can make it up during the next Foundation Classes series. We understand that emergencies happen, and our team will work with you to ensure you can complete all four sessions."
    },
    {
      question: "Is childcare provided during the classes?",
      answer: "Yes, childcare is provided for children ages 0-10 during the Sunday morning sessions. Please indicate on your registration form if you will need childcare services."
    },
    {
      question: "Do I need to bring anything to the classes?",
      answer: "We recommend bringing a Bible, notebook, and pen. We will provide all other materials, including a Foundation Classes workbook."
    },
    {
      question: "Is there a fee for the classes?",
      answer: "No, Foundation Classes are offered free of charge as part of our ministry to help people grow in their faith and become connected to our church family."
    }
  ];
  ...
  const handleSubmit = (e) => {
    ...
    fetch('/api/foundation-classes/register', {
      method: 'POST',
      headers: {
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 text-gray-900 dark:text-gray-100">
        ...
        <div className="container mx-auto px-4 relative z-10 h-full flex flex-col justify-center items-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-100 max-w-2xl mx-auto leading-relaxed font-light mb-8">
              Build a strong biblical foundation and prepare for church membership
            </p>
      ...
      <div className="container mx-auto px-4 py-16 max-w-6xl">
        ...
        >
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
            <div className="p-8 md:p-12">
              <h2 className="text-3xl font-bold mb-6 text-blue-600 dark:text-blue-400">What Are Foundation Classes?</h2>
              <p className="text-lg text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
                Foundation Classes are a 4-week journey designed to establish a strong biblical foundation and prepare you for meaningful church membership. Whether you're new to Christianity or looking to take your next step of commitment, these classes will equip you with essential knowledge and practical tools for your faith journey.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-xl">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    One class per week, building progressively on biblical foundations and church community.
                  </p>
                </div>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-xl">
                  ...
                  <h3 className="text-xl font-semibold mb-2">Membership Pathway</h3>
                  <p className="text-gray-700 dark:text-gray-300">
                    Completion of all classes is required for church membership and leadership opportunities.
                  </p>
                </div>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-xl">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    All materials are provided free of charge as part of our ministry to help you grow.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl shadow-xl overflow-hidden">
            <div className="p-8 md:p-12 text-white">
              ...
              <p className="text-lg opacity-90 mb-10 max-w-3xl">
                Our curriculum is designed to provide a comprehensive foundation for your faith journey and church membership. Each week builds on the previous one to create a complete understanding.
              </p>
                      ...
                      <div className="flex flex-col md:flex-row md:items-center gap-6">
                        ...
                        <div className="flex-grow">
                          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                            <div>
                              <span className="bg-blue-700 text-xs font-bold py-1 px-2 rounded-full">WEEK {session.week}</span>
                              <h3 className="text-xl md:text-2xl font-semibold mt-2">{session.title}</h3>
                            </div>
                          </div>
                          <p className="opacity-90 mb-4">{session.description}</p>
        ...
        >
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
            <div className="p-8 md:p-12">
              <h2 className="text-3xl font-bold mb-6 text-gray-800 dark:text-white">Upcoming Classes</h2>
              <p className="text-lg text-gray-700 dark:text-gray-300 mb-8">
                Classes are offered quarterly throughout the year. Registration is required as space is limited. Select your preferred session when you register.
              </p>
                  ...
                  >
                    <div className="bg-blue-600 p-4 text-white">
                      <div className="flex justify-between items-center">
                        <h3 className="font-semibold">{classSession.day} Series</h3>
                    ...
                    <div className="p-6">
                      <div className="flex items-start gap-3 mb-4">
                        ...
                        <div>
                          <div className="font-medium">{classSession.startDate} - {classSession.endDate}</div>
                          <div className="text-sm text-gray-600 dark:text-gray-400">{classSession.time}</div>
                        </div>
                      </div>
                      <div className="flex items-start gap-3 mb-6">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-gray-600 dark:text-gray-400">{classSession.location}</div>
                        </div>
                      </div>
                      <a
                        href="#register"
        ...
        >
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
            <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-8 text-white">
              <h2 className="text-3xl font-bold">Register for Foundation Classes</h2>
              <p className="mt-2 opacity-80">
            ...
            {formSubmitted ? (
              ...
              >
                ...
                <p className="text-lg text-gray-700 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
                  Thank you for registering for Foundation Classes. We've sent a confirmation email to <strong>{formData.email}</strong> with all the details you need.
                </p>
                <p className="text-md text-gray-600 dark:text-gray-400 mb-8">
                  If you have any questions before your first class, please contact our church office.
                </p>
              ...
              <form onSubmit={handleSubmit} className="p-8 md:p-12 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:border-gray-600 ${
                      formErrors.preferredSession ? "border-red-500 dark:border-red-500" : "border-gray-300"
                    }`}
                  >
                    <option value="">Select a session</option>
                    {upcomingClasses.map((classSession, index) => (
                      <option key={index} value={`${classSession.startDate} (${classSession.day})`}>
                        {classSession.startDate} - {classSession.day} {classSession.time}
                      </option>
                    ))}
                  </select>
                  {formErrors.preferredSession && (
                    <p className="mt-2 text-red-500 text-sm">{formErrors.preferredSession}</p>
                  )}
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="p-10 text-white">
                <blockquote>
                  ...
                  <p className="text-xl italic mb-6">
                    The Foundation Classes gave me clarity about my faith and how to live it out daily. I met wonderful people who became friends, and I finally understand what it means to be part of a church family.
                  </p>
                  <footer className="text-blue-200">
                    <cite>— John Banda, Completed Foundation Classes in 2023</cite>
                  </footer>
                </blockquote>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm p-8 md:p-10 flex flex-col justify-center">
                ...
                <p className="text-gray-100 mb-6">
                  Foundation Classes are your first step toward meaningful church membership and a stronger walk with God.
                </p>
