...
const TestMedia = () => {
  ...
  const testImageFormats = (mediaItem) => {
    ...
    if (mediaItem.path) {
      urls.push({
        ...
        url: mediaItem.path.includes('http') ? mediaItem.path : `http://localhost:3000${mediaItem.path}`
      });
    }
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <p className="mb-4">This page tests different ways to display uploaded media files.</p>
