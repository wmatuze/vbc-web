...
import { login, isAuthenticated, logout, verifyAuth, getCurrentUser } from '../services/api';
...
const Admin = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (notificationDropdownOpen && !event.target.closest('.notification-area')) {
  ...
  const navigationItems = [
    ...
    { id: 'members', label: 'Membership', icon: IdentificationIcon, count: null },
  ...
  if (!authenticated) {
    return (
      <div className={`min-h-screen flex items-center justify-center px-4 transition-colors duration-200 ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'}`}>
        <div className="max-w-md w-full">
          ...
          <div className={`rounded-xl shadow-lg p-8 transition-colors duration-200 ${darkMode ? 'bg-gray-800 border border-gray-700' : 'bg-white'}`}>
            ...
            {loginError && (
              <div className={`border-l-4 p-4 mb-6 ${darkMode ? 'bg-red-900/30 border-red-600 text-red-200' : 'bg-red-50 border-red-400 text-red-700'}`}>
                <div className="flex">
  ...
  return (
    <div className={`min-h-screen flex flex-col transition-colors duration-200 ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'}`}>
      {/* Top Navigation */}
      <header className={`shadow-sm z-20 transition-colors duration-200 ${darkMode ? 'bg-gray-800 border-b border-gray-700' : 'bg-white'}`}>
        <div className="h-16 px-4 flex items-center justify-between">
          <div className="flex items-center">
            ...
            <div className="flex items-center">
              ...
              />
              <span className={`ml-3 font-semibold transition-colors duration-200 ${darkMode ? 'text-white' : 'text-gray-800'}`}>
                Admin Portal
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="relative notification-area">
              ...
              {notificationDropdownOpen && (
                <div className={`absolute right-0 mt-2 w-80 rounded-lg shadow-lg z-50 overflow-hidden transition-colors duration-200 ${
                  darkMode 
                  ...
                  <div className={`p-2 border-t text-center transition-colors duration-200 ${
                    darkMode ? 'border-gray-700' : 'border-gray-200'
                  }`}>
            ...
            <div className="flex items-center space-x-3">
              <div className={`text-right hidden sm:block transition-colors duration-200 ${
        ...
        <main className={`flex-1 overflow-y-auto transition-colors duration-200 ${darkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
          <div className="p-6 flex flex-col h-full">
            ...
            <div className="mb-6">
              ...
              <p className={`mt-1 text-sm transition-colors duration-200 ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                Manage your {navigationItems.find(item => item.id === activeTab)?.label.toLowerCase() || 'dashboard'} content
              </p>
            </div>
            
            {/* Content Card */}
            <div className={`rounded-xl shadow-sm p-6 flex-1 mb-6 transition-colors duration-200 ${
              darkMode 
                ? 'bg-gray-800 border border-gray-700' 
                : 'bg-white'
            }`}>
            ...
            {/* Footer */}
            <footer className={`rounded-lg shadow-sm p-4 mt-auto transition-colors duration-200 ${
              darkMode 
                ? 'bg-gray-800 border border-gray-700' 
                : 'bg-white'
            }`}>
              <div className="flex flex-col sm:flex-row items-center justify-between">
                <div className={`text-sm mb-3 sm:mb-0 transition-colors duration-200 ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                  &copy; {currentYear} Victory Bible Church. All rights reserved.
                </div>
