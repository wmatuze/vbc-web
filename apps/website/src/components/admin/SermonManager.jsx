...
import { getSermons, createSermon, updateSermon, deleteSermon } from '../../services/api';
import {
  PlusIcon,
  PencilIcon,
  TrashIcon,
...
const SermonManager = () => {
  ...
  const seriesList = ['all', ...new Set(sermons.filter(s => s.series).map(s => s.series))];
    ...
    <div className="p-6">
      ...
      <div className="mb-6 flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <SortAscendingIcon className={`h-5 w-5 transform ${sortOrder === 'desc' ? 'rotate-180' : ''}`} />
          </button>
        </div>
      </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="mt-1 flex items-center space-x-2">
                        ...
                        <button
                          type="button"
                          onClick={() => window.open('/admin?tab=media', '_blank')}
                      ...
                      {currentSermon.imageUrl && (
                        <div className="mt-2">
                          <div className="relative rounded-lg overflow-hidden bg-gray-100" style={{ height: '150px' }}>
                            <img
                            ...
                            <button
                              type="button"
                              onClick={() => setCurrentSermon(prev => ({ ...prev, imageUrl: '' }))}
